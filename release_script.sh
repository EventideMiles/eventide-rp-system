...
cd "$TEMP_DIR/eventide-rp-system" && zip -r eventide-rp-system.zip *

# Move the zip file to the releases directory
mv "$TEMP_DIR/eventide-rp-system/eventide-rp-system.zip" "$WORKING_DIR/releases/eventide-rp-system.zip"
