...
### 🔄 Bidirectional Transformation-Actor Conversion
...
### 🖱️ Drag and Drop Actor Transformation
...
- Tiny → 0.5 grid units
- Small → 0.8 grid units
- Medium → 1 grid unit
- Large → 2 grid units
- Huge → 3 grid units
- Gargantuan → 4 grid units
...
- Select for actor type (transformation → actor only)
