    ...
    content: `
          <form>
            ...
            <div class="form-group">
              ...
              <button type="button" id="file-picker" data-type="image" data-target="img" class="file-picker">Browse</button>
              <img id="image-preview" src="icons/svg/item-bag.svg" style="max-width: 100px; max-height: 100px; display: block; margin-top: 10px;" alt="Image Preview">
            </div>
            <div class="form-group">
              <label for="bgColor">Background Color:</label>
              <input type="color" id="bgColor" name="bgColor" value="#7B4874">
            </div>
            <div class="form-group">
              ...
              ${abilities
                .map((ability) => {
                  ...
                  <label for="${ability.toLowerCase()}"> ${ability}:</label>
                  <input type="number" id="${ability.toLowerCase()}" name="${ability.toLowerCase()}" value="0">
                  <select id="${ability.toLowerCase()}-mode" name="${ability.toLowerCase()}-mode">
              ...
              ${hiddenAbilities
                ...
                .join("")}
                <input type="text"  id="img" name="img" placeholder="Image URL" value="icons/svg/item-bag.svg" style="display: none;" disabled>
          </form>
        `,
    buttons: {
      yes: {
        ...
        callback: async (html) => {
          ...
          // Create the status item on the actor
          await actor.createEmbeddedDocuments("Item", [statusItem]);
        },
      },
    },
    render: async (html) => {
      ...
      // inputImg.addEventListener("input", () => previewUpdate());
