    ...
    while (1) {
      switch ((_context.prev = _context.next)) {
        ...
        case 4:
          ...
          label = dataSet.label
            ? '<h3 style="color:white;background-color:#512DA8;text-align:center;padding-top:10px;padding-bottom:10px;font-size:1.25em;">[ability]</h3> '.concat(
                dataSet.label
              )
            : "";
          ...
          if (
            ...
            label = "".concat(
              label,
              ' <h3 class="eventide-critical-hit"><i class="fa-solid fa-meteor"></i> Critical Hit!</h3>'
            );
          } else if (result.terms[0].results[0].result === 1) {
            label = "".concat(
              label,
              ' <h3 class="eventide-critical-miss"><i class="fa-solid fa-flag"></i> Critical Miss!</h3>'
            );
          }
